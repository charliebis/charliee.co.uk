    ...
    <div class="hero-content text-center">
        <div class="max-w-5xl mt-8 mb-8 lg:mt-16 lg:mb-16 flex items-center justify-center flex-col">
            ...
            <p class="pt-8 pb-5 lg:pt-12 text-xl lg:text-2xl">
                Here are a few of the projects I've worked on over the last few years.
            </p>
...
<section class="container flex flex-col lg:flex-row gap-5 items-stretch justify-center justify-items-center mx-auto -mt-36 mb-5">
    <div class="lg:w-1/2 flex-grow bg-primary rounded-box place-items-center p-8 mx-3 lg:mx-0">
        ...
        <p class="text-lg lg:text-xl pt-6 pb-6">
            My most recent, full-time role. Working at <a class="link" href="https://www.glide.co.uk" title="Glide" target="_blank">Glide</a> has given me valuable exposure to much larger systems and applications than most of my previous roles.
            I have had the opportunity to work on the main company website, internal APIs (including Laravel APIs), as well as the company's internal back-office system. This
            system is a monolithic PHP application with a mature and extensive code base, providing me with some interesting challenges.
        </p>
        <p class="text-lg lg:text-xl pb-6">
            ...
            which produced large amounts of financial data, sanitising and chunking that data, before pushing that data to X3 via its SOAP API. It also required the handling of data
            pulled from X3 into the company database. Despite some technical challenges, in particular those caused by the sheer volume of data being processed, the project was successful.
        </p>
        <p class="text-lg lg:text-xl pb-6">
            As a senior engineer, my time at <a class="link" href="https://www.glide.co.uk" title="Glide" target="_blank">Glide</a> has also involved the mentoring of more junior engineers as well as attending (and often representing the devlopment team at) regular management
            meetings.
        </p>
    </div>
    <div class="lg:w-1/2 flex-grow bg-primary rounded-box place-items-center p-8 mx-3 lg:mx-0">
